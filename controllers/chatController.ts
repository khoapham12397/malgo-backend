...
import { getChatSessionP2PList, getGroupMessage, getGroupPostMsg, getMessageP2P } from '../services/chatService';
...
export const getGroupMsgCtl = async(req: Request, res: Response)=>{
    try{
        ...
        const messages = await getGroupMessage(groupId, username, params);
